...
namespace ecomFront.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "El telefono debe tener al menos 8 digitos", MinimumLength = 8)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = Input.UserName, Email = Input.Email, PhoneNumber = Input.Phone, Nombre = Input.Nombre, Apellido = Input.Apellido, Empresa = Input.Empresa };
